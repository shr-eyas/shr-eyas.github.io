    ...
    <div className="h-screen lg:overflow-hidden overflow-auto bg-background text-foreground px-6 md:px-12 lg:px-24 flex items-center">
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
          <div className="lg:w-3/5 space-y-8 lg:-mt-40">
            <h1 className="text-4xl md:text-6xl font-bold leading-normal slide-in">
          ...
          <div className="lg:w-[45%] relative">
            <div className="glow-effect">
              <img 
                ...
                className="w-full max-w-[400px] lg:max-w-[500px] h-auto fade-in relative z-10"
              />
            </div>
          </div>
        </div>
